...
function toObservable(value) {
  const obs = isPromise(value) ? (0, import_rxjs2.from)(value) : value;
...
var AbstractControl = class {
  ...
  constructor(validators, asyncValidators) {
    ...
    this._events = new import_rxjs2.Subject();
...
var ngbRunTransition = (zone, element, startFn, options) => {
  ...
  const transition$ = new import_rxjs3.Subject();
  const finishTransition$ = new import_rxjs3.Subject();
  const stop$ = transition$.pipe((0, import_operators3.endWith)(true));
...
var NgbDatepickerService = class _NgbDatepickerService {
  constructor() {
    ...
    this._model$ = new import_rxjs3.Subject();
    this._dateSelect$ = new import_rxjs3.Subject();
    this._state = {
...
var NgbInputDatepicker = class _NgbInputDatepicker {
  constructor() {
    ...
    this._destroyCloseHandlers$ = new import_rxjs3.Subject();
...
var NgbModalRef = class {
  ...
  constructor(_windowCmptRef, _contentRef, _backdropCmptRef, _beforeDismiss) {
    ...
    this._dismissed = new import_rxjs3.Subject();
    this._hidden = new import_rxjs3.Subject();
...
var NgbModalWindow = class _NgbModalWindow {
  constructor() {
    ...
    this.shown = new import_rxjs3.Subject();
...
var NgbModalStack = class _NgbModalStack {
  constructor() {
    ...
    this._activeWindowCmptHasChanged = new import_rxjs3.Subject();
...
var NgbNav = class _NgbNav {
  constructor(role) {
    ...
    this.shown = new EventEmitter();
    this.hidden = new EventEmitter();
    this.navItemChange$ = new import_rxjs3.Subject();
